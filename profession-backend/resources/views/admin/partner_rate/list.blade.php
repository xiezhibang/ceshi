                    ...
                    <div class="row">
                        ...
                        <form action="" class="form-inline pull-right">
                            ...
                            <div class="form-group">
                                <input type="text" name="" class="form-control" placeholder="请输入" id="" value="">
                            </div>
                        ...
                        <div class="head-tab" style="margin-left: 15px;">
                            ...
                            <a href="{{route('ratio.create')}}" class="btn btn-sm btn-primary" title="添加合伙人收益比例">
                                <i class="fa fa-plus-circle"></i><span class="hidden-xs">&nbsp;&nbsp;添加合伙人收益比例</span>
                            </a>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover m-t-md">
                            ...
                            <tr>
                                ...
                                <th class="text-center" width="100">收益比例</th>
