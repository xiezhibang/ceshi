                ...
                <div class="ibox-content">
                    ...
                    <div class="row">
                        ...
                        <div class="head-tab" style="margin-left: 15px;">
                            ...
                            <a href="{{route('goodcategory.create')}}" class="btn btn-sm btn-primary" title="添加商品分类">
                                <i class="fa fa-plus-circle"></i><span class="hidden-xs">&nbsp;&nbsp;添加商品分类</span>
                            </a>
                        ...
                        <table class="table table-striped table-bordered table-hover m-t-md">
                            ...
                            @foreach($results as $k => $item)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <a href="/admin/goodcategory/{{$item->id}}/edit">
                                                <button class="btn btn-primary btn-xs" type="button"><i class="fa fa-paste"></i> 编辑</button>
                                            </a>
                                            <a href="/admin/goodcategory/lower/{{$item->id}}">
                                                <button class="btn btn-primary btn-xs" type="button"><i class="fa fa-paste"></i> 查看下级</button>
                                            </a>
                                            <a href="{{route('goodcategory.destroy',$item->id)}}">
