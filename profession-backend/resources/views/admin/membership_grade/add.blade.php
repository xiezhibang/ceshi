    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="ibox-content">
                ...
                <form class="form-horizontal m-t-md" action="{{ route('shipgrade.store') }}" method="post" accept-charset="UTF-8" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">年费（元）：</label>
                        <div class="input-group col-sm-2">
                            <input type="text" class="form-control" name="annual_fee" value="{{old('annual_fee')}}" required data-msg-required="请输入年费">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group col-sm-1">
                            <select class="form-control" name="type">
                                <option value="1" @if(old('type') == 1) selected="selected" @endif>绿卡</option>
                                <option value="2" @if(old('type') == 2) selected="selected" @endif>金卡</option>
                                <option value="3" @if(old('type') == 3) selected="selected" @endif>黑金卡</option>
                            </select>
                            @if ($errors->has('type'))
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">会员有效期（年）：</label>
                        <div class="input-group col-sm-2">
                            <input type="text" class="form-control" name="period_time" value="{{old('period_time')}}" required data-msg-required="请输入会员有效期">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">优惠折扣（折）：</label>
                        <div class="input-group col-sm-2">
                            <input type="text" class="form-control" name="discount" value="{{old('discount')}}" required data-msg-required="请输入优惠折扣">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group col-sm-2">
                            <input type="text" class="form-control" name="consumer" value="{{old('consumer')}}" required data-msg-required="请输入直推消费收益">
