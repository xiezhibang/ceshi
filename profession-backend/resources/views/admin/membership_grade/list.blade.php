                ...
                <div class="ibox-content">
                    ...
                    <div class="row">
                        ...
                        <div class="head-tab" style="margin-left: 15px;">
                            ...
                            <a href="{{route('shipgrade.create')}}" class="btn btn-sm btn-primary" title="添加会员等级收益">
                                <i class="fa fa-plus-circle"></i><span class="hidden-xs">&nbsp;&nbsp;添加会员等级收益</span>
                            </a>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover m-t-md">
                            ...
                            <tr>
                                ...
                                <th class="text-center" width="100">年费（元）</th>
                                <th class="text-center" width="100">会员有效期（天）</th>
                                <th class="text-center" width="100">优惠折扣（折）</th>
                                <th class="text-center" width="100">直推消费收益（%）</th>
