    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="ibox-content">
                ...
                <form class="form-horizontal m-t-md" action="{{ route('interest.update',$info->id) }}" method="post" accept-charset="UTF-8" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                    {{method_field('PATCH')}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group col-sm-1">
                            <select class="form-control" name="type">
                                <option value="7" @if($info->type == 7) selected="selected" @endif>绿卡</option>
                                <option value="8" @if($info->type == 8) selected="selected" @endif>金卡</option>
                                <option value="9" @if($info->type == 9) selected="selected" @endif>黑金卡</option>
                            </select>
                            @if ($errors->has('type'))
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group col-sm-1">
                            <select class="form-control" name="interest_type">
                                <option value="10" @if($info->interest_type == 10) selected="selected" @endif>否</option>
                                <option value="20" @if($info->interest_type == 20) selected="selected" @endif>是</option>
                            </select>
