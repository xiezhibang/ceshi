    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="ibox-content">
                ...
                <form class="form-horizontal m-t-md" action="{{ route('engineer.update',$info->id) }}" method="post" accept-charset="UTF-8" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                    {{method_field('PATCH')}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group col-sm-2">
                            <input type="text" class="form-control" name="engineer_name" value="{{$info->engineer_name}}" required data-msg-required="请输入项目名称">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group col-sm-2">
                            <input type="text" class="form-control" name="league_money" value="{{$info->league_money}}" required data-msg-required="请输入合伙金额">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group col-sm-2">
                            <input type="text" class="form-control" name="league_time" value="{{$info->league_time}}" required data-msg-required="请输入合伙期限">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group col-sm-2">
                            <input type="text" class="form-control" name="league_scale" value="{{$info->league_scale}}" required data-msg-required="请输入合伙奖励比例">
