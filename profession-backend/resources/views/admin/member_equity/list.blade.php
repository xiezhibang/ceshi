                ...
                <div class="ibox-content">
                    ...
                    <div class="row">
                        ...
                        <div class="head-tab" style="margin-left: 15px;">
                            ...
                            <a href="{{route('equity.create')}}" class="btn btn-sm btn-primary" title="添加会员权益介绍">
                                <i class="fa fa-plus-circle"></i><span class="hidden-xs">&nbsp;&nbsp;添加会员权益介绍</span>
                            </a>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover m-t-md">
                            ...
                            <tr>
                                ...
                                <th class="text-center" width="100">权益名称</th>
                            ...
                            @foreach($results as $k => $item)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @if($item->type == 10)
                                            <span class="text-navy">金卡</span>
                                        @elseif($item->type == 20)
                                            <span class="text-danger">黑金卡</span>
                                        @endif
                                    </td>
