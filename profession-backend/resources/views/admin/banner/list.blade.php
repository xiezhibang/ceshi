                    ...
                    <div class="row">
                        ...
                        <form action="" class="form-inline pull-right">
                            ...
                            <div class="form-group">
                                <input type="text" name="name" class="form-control" placeholder="请输入名称" id="" value="">
                            </div>
                        ...
                        <div class="head-tab" style="margin-left: 15px;">
                            ...
                            <a href="{{route('banner.create')}}" class="btn btn-sm btn-primary" title="添加Banner图">
                                <i class="fa fa-plus-circle"></i><span class="hidden-xs">&nbsp;&nbsp;添加Banner图</span>
                            </a>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover m-t-md">
                            ...
                            <tr>
                                ...
                                <th class="text-center" width="130">名称</th>
                                <th class="text-center" width="100">Banner图</th>
                                <th class="text-center" width="130">链接</th>
                                <th class="text-center" width="100">排序</th>
                                <th class="text-center" width="100">状态</th>
                                <th class="text-center" width="100">Banner类型</th>
                            ...
                            @foreach($results as $k => $item)
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ $item->banner_image }}" alt="" width="100px" height="100px">
                                    </td>
