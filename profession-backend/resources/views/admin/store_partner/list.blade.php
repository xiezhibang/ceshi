                    ...
                    <div class="row">
                        ...
                        <form action="" class="form-inline pull-right">
                            ...
                            <div class="form-group">
                                <input type="text" name="shop_account" class="form-control" placeholder="请输入店铺账号" id="" value="{{ $request->shop_account }}">
                            </div>
                            ...
                            <div class="form-group">
                                <input type="text" name="username" class="form-control" placeholder="请输入联系人" id="" value="{{ $request->username }}">
                            </div>
