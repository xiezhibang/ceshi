    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="ibox-content">
                ...
                <form class="form-horizontal m-t-md" action="{{ route('upgradeuser.store') }}" method="post" accept-charset="UTF-8" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group col-sm-1">
                            <select class="form-control" name="type">
                                <option value="4" @if(old('type') == 4) selected="selected" @endif>绿卡</option>
                                <option value="5" @if(old('type') == 5) selected="selected" @endif>金卡</option>
                                <option value="6" @if(old('type') == 6) selected="selected" @endif>黑金卡</option>
                            </select>
                            @if ($errors->has('type'))
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group col-sm-2">
                            <input type="text" class="form-control" name="gold_card" value="{{old('gold_card')}}" required data-msg-required="请输入推荐升级金卡">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group col-sm-2">
                            <input type="text" class="form-control" name="black_gold_card" value="{{old('black_gold_card')}}" required data-msg-required="请输入推荐升级黑金卡">
