                ...
                <div class="ibox-content">
                    ...
                    <div class="row">
                        ...
                        <div class="head-tab" style="margin-left: 15px;">
                            ...
                            <a href="{{route('upgradeuser.create')}}" class="btn btn-sm btn-primary" title="添加会员升级收益">
                                <i class="fa fa-plus-circle"></i><span class="hidden-xs">&nbsp;&nbsp;添加会员升级收益</span>
                            </a>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover m-t-md">
                            ...
                            <tr>
                                ...
                                <th class="text-center" width="100">推荐升级金卡</th>
                                <th class="text-center" width="100">推荐升级黑金卡</th>
                            ...
                            @foreach($results as $k => $item)
                                <tr>
                                    ...
                                    <td class="text-center">{{ $item->gold_card }}</td>
                                    <td class="text-center">{{ $item->black_gold_card }}</td>
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <a href="/admin/upgradeuser/{{$item->id}}/edit">
                                                <button class="btn btn-primary btn-xs" type="button"><i class="fa fa-paste"></i> 编辑</button>
                                            </a>
                                            <a href="{{route('upgradeuser.destroy',$item->id)}}">
