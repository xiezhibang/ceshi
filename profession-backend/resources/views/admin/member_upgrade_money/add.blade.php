    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="ibox-content">
                ...
                <form class="form-horizontal m-t-md" action="{{ route('upgradeprice.store') }}" method="post" accept-charset="UTF-8" enctype="multipart/form-data">
                    {!! csrf_field() !!}

                    <div class="form-group">
                        <label class="col-sm-2 control-label">描述：</label>
                        <div class="input-group col-sm-2">
                            <input type="text" class="form-control" name="remark" value="{{old('remark')}}" required data-msg-required="请输入描述">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group col-sm-2">
                            <input type="text" class="form-control" name="money" value="{{old('money')}}" required data-msg-required="请输入升级金额">
                            @if ($errors->has('money'))
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group col-sm-1">
                            <select class="form-control" name="upgrade_type">
                                <option value="1" @if(old('upgrade_type') == 1) selected="selected" @endif>金卡升级</option>
                                <option value="2" @if(old('upgrade_type') == 2) selected="selected" @endif>黑金卡升级</option>
                            </select>
