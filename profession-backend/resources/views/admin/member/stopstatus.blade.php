    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="ibox-content">
                ...
                <form class="form-horizontal m-t-md" action="{{ route('member.stopstatus',$info->id) }}" method="post" accept-charset="UTF-8" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                    ...
                    <div class="form-group">
                        <div class="col-sm-12 col-sm-offset-2">
                            <button class="btn btn-primary" type="submit"><i class="fa fa-check"></i>&nbsp;确定禁用</button>
                        </div>
                    </div>
